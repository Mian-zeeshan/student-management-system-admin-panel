...
import '../../common/dialog_for_course_assign.dart';
                      ...
                      Card(
                        ...
                        child: Column(
                          children: [
                            ...
                            Consumer<CustomerAdminProvider>(builder: (context, value, child) {
                              return  Padding(
                                                          ...
                                                          children: [
                                                            FutureBuilder<String>(
                                                                future: FirebaseCrud.getNameById(
                                                                    snapshot.data!.docs[index]['subjectId'].toString(),
                                                                    'Subject',
                                                                    'subjectName'),
                                                                builder:
                                                                    (BuildContext context, AsyncSnapshot<String> text) {
                                                                  return Text(
                                                                    text.data.toString()[0].toUpperCase()+ text.data.toString().substring(1),
